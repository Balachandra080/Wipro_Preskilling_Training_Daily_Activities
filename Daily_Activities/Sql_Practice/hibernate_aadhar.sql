...
CREATE TABLE `aadhar` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKmq7uuk0aenvobg2vn1cs3jdib` (`teacher_id`),
  CONSTRAINT `FKmq7uuk0aenvobg2vn1cs3jdib` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`id`)
...
INSERT INTO `aadhar` VALUES (1,'A0001',1),(2,'A0003',2);
