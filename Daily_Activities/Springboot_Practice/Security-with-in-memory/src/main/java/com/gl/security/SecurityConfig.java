...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        ...
        // create a new user for this Spring Boot in memory authentication
        ...
        UserDetails user3 = User.withUsername("employee").password("{noop}12345").roles("employee").build();
        UserDetails user4 = User.withUsername("principal").password("{noop}12345").roles("admin", "student").build();
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
        		.requestMatchers("/global/**").permitAll()  // Do not even require use
